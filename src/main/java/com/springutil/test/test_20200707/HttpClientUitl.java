...
public class HttpClientUitl {
    ...
    public static void main(String[] args) {
        // 天气API：http://www.tianqiapi.com/
        // String url = "https://yiketianqi.com/api";
        String url = "https://tianqiapi.com/free/day";
        List<NameValuePair> list = new ArrayList<>();
        list.add(new BasicNameValuePair("version","v61"));
        list.add(new BasicNameValuePair("appid","459686**"));
        list.add(new BasicNameValuePair("appsecret","E60DTa**"));
        list.add(new BasicNameValuePair("cityid","101090907"));
        System.out.println(doHttpGet(url, list));
    }
}
