...
public class EmailUtil {
    ...
    // 登录账户
    private static String account = "jiaohongtao@beyondcent.com";
    // 登录密码
    private static String password = "mimamima";
    // 服务器地址
    ...
    public static void main(String[] args) {
        // ,1007760854@qq.com
        String receiverList = "jiaohongtaovip@163.com";
        String fileSrc = "C:\\Users\\jiaohongtao\\Desktop\\Title.xml";
        EmailUtil emailUtil = new EmailUtil();
        emailUtil.send("jiao", "HAHA", "aaaa", receiverList, fileSrc);
    }
}
